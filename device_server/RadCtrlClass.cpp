...
//=============================================================================
//
// file :        RadCtrlClass.cpp
//
// description : C++ source for the RadCtrlClass.
//               A singleton class derived from DeviceClass.
//               It implements the command and attribute list
//               and all properties and methods required
//               by the RadCtrl once per process.
//
// project :     RadControl
//
// $Author:  $
...
RadCtrlClass::RadCtrlClass(string &s):Tango::DeviceClass(s)
{
  ...
  read(fd,&NDETECTORS,4);//TODO handle failure
  shmem=(char*)mmap(NULL,4+NDETECTORS*sizeof(DetectorData),PROT_READ,MAP_SHARED,fd,0);
  if(shmem==MAP_FAILED)throw "MMAP_FAILED";
  data=(DetectorData*)(shmem+4);
  close(fd);
...
void RadCtrlClass::attribute_factory(vector<Tango::Attr *> &att_list)
{
	...
	expositionAttrib	*exposition = new expositionAttrib();
	Tango::UserDefaultAttrProp	exposition_prop;
	//	description	not set for exposition
	exposition_prop.set_label("Exposition");
	exposition_prop.set_unit("milliseconds");
	exposition_prop.set_standard_unit("ms");
	exposition_prop.set_display_unit("ms");
	//	format	not set for exposition
	//	max_value	not set for exposition
	//	min_value	not set for exposition
	//	max_alarm	not set for exposition
	//	min_alarm	not set for exposition
	//	max_warning	not set for exposition
	//	min_warning	not set for exposition
	//	delta_t	not set for exposition
	//	delta_val	not set for exposition
	
	exposition->set_default_properties(exposition_prop);
	//	Not Polled
	exposition->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	att_list.push_back(exposition);
